...
| OneDrivePermissions | DAGOneDriveForBusinessEveryone, DAGOneDriveForBusinessEveryoneExceptExternalUsers, DAGOneDriveForBusinessEveryoneExceptExternalUsersAtSite, DAGOneDriveForBusinessEveryoneExceptExternalUsersForItems, DAGOneDriveForBusinessPermissionedUsers, DAGOneDriveForBusinessPermissionsReport, DAGOneDriveForBusinessSensitivityLabelForFiles, DAGOneDriveForBusinessSharingLinks_Anyone, DAGOneDriveForBusinessSharingLinks_Guests, DAGOneDriveForBusinessSharingLinks_PeopleInYourOrg, ScopedItemPermissions | Review full ACL/inheritance and exposure outside selected drives and DAG scopes. |
